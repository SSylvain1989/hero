    ...
    <div className="legal-notices__encart">
      ...
      <div className="legal-notices__text">
        ...
        <p><strong>Propriétaire</strong> : Etudiants O'clock – Start up – 75000<br />
          ...
          <strong>Webmaster</strong> : Wesley Boosko – mail2@mail.com<br />
          <strong>Hébergeur</strong> : localhost – 75000<br />
        ...
        <p><br />L’utilisation du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> implique l’acceptation pleine et entière des conditions générales d’utilisation ci-après décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> sont donc invités à les consulter de manière régulière.</p>
        ...
        <p>Le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> est mis à jour régulièrement par Wesley Boosko. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre connaissance.</p>
        <h3><br />3. Description des services fournis.</h3>
        <p><br />Le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> a pour objet de fournir une information concernant l’ensemble des activités de la société.</p>
        <p>Etudiants O'clock s’efforce de fournir sur le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> des informations aussi précises que possible. Toutefois, il ne pourra être tenue responsable des omissions, des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations.</p>
        <p>Tous les informations indiquées sur le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne.</p>
        ...
        <p>Etudiants O'clock ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a>.</p>
        ...
        <p>A l'occasion de l'utilisation du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a>, peuvent êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a>, le fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet (IP) de l'utilisateur.</p>
        <p> En tout état de cause Etudiants O'clock ne collecte des informations personnelles relatives à l'utilisateur que pour le besoin de certains services proposés par le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a>. L'utilisateur fournit ces informations en toute connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à l'utilisateur du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> l’obligation ou non de fournir ces informations.</p>
        <p>Conformément aux dispositions des articles 38 et suivants de la loi 78-17 du 6 janvier 1978 relative à l’informatique, aux fichiers et aux libertés, tout utilisateur dispose d’un droit d’accès, de rectification et d’opposition aux données personnelles le concernant, en effectuant sa demande écrite et signée, accompagnée d’une copie du titre d’identité avec signature du titulaire de la pièce, en précisant l’adresse à laquelle la réponse doit être envoyée.</p>
        <p>Aucune information personnelle de l'utilisateur du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> n'est publiée à l'insu de l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de Etudiants O'clock et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a>.</p>
        <p>Les bases de données sont protégées par les dispositions de la loi du 1er juillet 1998 transposant la directive 96/9 du 11 mars 1996 relative à la protection juridique des bases de données.</p>
        <h3><br />8. Liens hypertextes et cookies.</h3>
        <p><br />Le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de Etudiants O'clock. Cependant, Etudiants O'clock n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait.</p>
        <p>La navigation sur le site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> est susceptible de provoquer l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un fichier de petite taille, qui ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation ultérieure sur le site, et ont également vocation à permettre diverses mesures de fréquentation.</p>
        ...
        <p><br />Tout litige en relation avec l’utilisation du site <a href="http://www.lewebsitedesheros.com/">www.lewebsitedesheros.com</a> est soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents de Paris.</p>
